...
// The contract that rotates on every pool op is PoolState (Pool config is
// immutable). We track PoolState transitions for swap detection, joining
// Pool config by poolId for the instrument ids.
